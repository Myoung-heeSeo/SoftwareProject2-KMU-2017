    ...
    def buttonClicked(self):
        ...
        if key == '=':
            ...
            self.display.setText(self.display.text()
                                 + Conlist[constantList.index(key)])

        elif key in functionList:
            n=self.display.text()

            Funlist = [calcFunctions.factorial(n), calcFunctions.decToBin(n),calcFunctions.binToDec(n),
                       calcFunctions.decToRoman(n), calcFunctions.romanToDec(n)]
            self.display.setText(str(Funlist[functionList.index(key)]))
